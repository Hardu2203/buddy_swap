...
class CoinApi {
  ...
  Future<T?> getData<T>(String path, [ T Function(Map<String, dynamic>)? mapping, Map<String, String>? headers ]) async {
    if (headers != null) {
      _headers.addAll(headers);
    }
    return await BaseRequest<T, Map<String, dynamic>>(_baseUrl, path,  ReqType.get, mapping, null, _headers).execute();
  }
